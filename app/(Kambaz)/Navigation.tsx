    ...
    return (
        <ListGroup className="rounded-0 position-fixed bottom-0 top-0 d-none d-md-block bg-black z-2" style={{ width: 110 }}
            ...
            <ListGroupItem className="border-0 bg-black text-center">
                <Link href="/Account/Profile" id="wd-account-link" className="text-white text-decoration-none">
            ...
            <ListGroupItem className='border-0 bg-black text-center'>
                ...
                <LuBookText className="fs-1 text-danger" />
                    <br />
                    Courses
                </Link>
            </ListGroupItem>
            ...
            <ListGroupItem className="border-0 bg-black text-center">
                ...
                <RiInbox2Line className="fs-1 text-danger" />
                <br />
                Inbox
            </Link>
            </ListGroupItem>
            <ListGroupItem className="border-0 bg-black text-center">
                ...
                <LuSettings className="fs-1 text-danger" />
                <br />
                Labs
            </Link>
            </ListGroupItem>
