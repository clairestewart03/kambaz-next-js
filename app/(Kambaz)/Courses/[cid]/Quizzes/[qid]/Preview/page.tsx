...
import * as attemptClient from "../StudentAttempt/client";
...
export default function QuizPreview() {
    ...
    const onSubmitQuiz = async () => {
        ...
        const encoded = encodeURIComponent(JSON.stringify(fakeAttempt));
        router.push(`/Courses/${cid}/Quizzes/${qid}/Preview/PreviewResults?data=${encoded}`);
    };
